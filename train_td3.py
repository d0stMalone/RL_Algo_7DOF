...
# Save model
torch.save(agent.actor.state_dict(), os.path.join(log_path, "td3_actor.pth"))
torch.save(agent.critic1.state_dict(), os.path.join(log_path, "td3_critic1.pth"))
torch.save(agent.critic2.state_dict(), os.path.join(log_path, "td3_critic2.pth"))
print("✅ TD3 model saved to td3_logs/")
...
print(f"📄 Training rewards saved to td3_logs/train_rewards.csv")
